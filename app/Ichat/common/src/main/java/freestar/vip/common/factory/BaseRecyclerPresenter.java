...
public class BaseRecyclerPresenter<ViewMode, View extends BaseContract.BaseRecyclerView> extends BasePresenter<View> {
    ...
    private void refreshDataOnUiThread(DiffUtil.DiffResult diffResult, List<ViewMode> dataList) {
        View view = getView();
        if (view == null) {
            return;
        }
